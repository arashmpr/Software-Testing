...
public class CommoditiesController {
    ...
    public ResponseEntity<String> rateCommodity(@PathVariable String id, @RequestBody Map<String, String> input) throws NumberFormatException , NotExistentCommodity{
        try {
    ...
    public ResponseEntity<String> addCommodityComment(@PathVariable String id, @RequestBody Map<String, String> input) {
        ...
        try {
            ...
            return new ResponseEntity<>(ignored.getMessage(), HttpStatus.NOT_FOUND);
        }
